...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-lg border border-input bg-background/50 px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-whiskey-gold/50 focus:border-whiskey-gold/50 disabled:cursor-not-allowed disabled:opacity-50 backdrop-blur-sm [&>span]:line-clamp-1 transition-all",
      className
    )}
    {...props}
  >
